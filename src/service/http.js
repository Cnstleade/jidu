...
export function getCustUserList(npage, pagesize, source, realName, phoneNumber, idcard, channel) {
  let data = {
    npage,
    pagesize,
    source,
...
//后台管理模块 /admin 电销中心 电销列表
export function findCustUserForSalesman(pageNumber, pageSize, startDate, endDate, promoter, phone, name, type, userId, salesmanId) {
  let data = {
    pageNumber,
    pageSize,
    startDate,
...
//后台管理模块 / 运营中心 售前营销
export function httpPreSalest(salesmanId, pageNumber, pageSize, keywords, startDate, endDate, userType, ) {
  let data = {
...
//后台管理模块 / 运营中心 售前营销
export function httpAfterSales(salesmanId, pageNumber, pageSize, keywords, startDate, endDate, userType, ) {
  let data = {
...
//后台管理模块 / 数据统计 还款列表
export function httpBaofurepaymentlist(npage, pagesize, begainTimeString, endTimeString, withdrawStatus, userName, IdCard, collectorId) {
  let data = {
...
//后台管理模块 /admin 催收分配管理 已经分配列表
export function httpElectricalStatistics(loginId, pageNumber, pageSize, salesmanId, startDate, endDate) {
  let data = {
    loginId,
    pageNumber,
    pageSize,
...
export function httpPaymentapplylist(loginId, paymentStatus, npage, pagesize, begainTimeString, endTimeString, IdCard, userName, phonenumber, execeedtimeType, collectorId) {
  let data = {
    loginId,
    paymentStatus,
    npage,
...
export function httpGetxinyanreport() {
  let data = {
    xyReportId: 1
  };
  let allCookies = document.cookie
  return axios({
    url: 'http://101.132.171.38:8082/sys/getxinyanreport',
    method: 'post',
    headers: {
      'Content-type': 'application/x-www-form-urlencoded',
...
export function httpUpdateCustomterMesage(loginId, userId, loanApplyId, userName, idNo, mobile) {
  let data = {
    loginId,
    userId,
    loanApplyId,
...
export function httpUpdateCustomterMesageImg(loginId, userId,
  fullFaceUrl,
  reverseStorageUrl,
  handStorageUrl) {
  let param = new FormData(); //创建form对象
  param.append('fullFaceUrl', fullFaceUrl); //通过append向form对象添加数据
  param.append('reverseStorageUrl', reverseStorageUrl); //通过append向form对象添加数据
  param.append('handStorageUrl', handStorageUrl); //通过append向form对象添加数据
...
export function httpUpdateCustomterMesageBank(loginId, userId,
  id,
  cardNum,
  bankName, type = 1) {
  let data = {
...
export function httpUpdateCustomterMesageMobile(loginId,
  custMobileList, type = 2) {
  let data = {
    loginId,
    type,
    custMobileList
...
/* 认证统计 */
export function httpGetcollectentrustlist(
  npage, pagesize, collectEntructStatus, begainTimeString, endTimeString
) {
  let data = {
    npage,
    pagesize,
  ...
  return axios({
    url: '/sys/getcollectentrustlist',
    method: 'post',
    data: qs.stringify(data)
  })
}

export function httpDocollectentrust(
  ids
) {
  let data = {
    ids
  ...
  return axios({
    url: '/sys/docollectentrust',
    method: 'post',
    data: qs.stringify(data)
  })
}

export function httpGetcompanypayaccount(

) {

  return axios({
    url: '/sys/getcompanypayaccount',
    method: 'get',
  })
}
...
export function httpUpdatecompanypayaccount(id, alipayAccount, companyPhone, weixinNumber, weixinName, uploadFile) {
  ...
  param.append('weixinNumber', weixinNumber); //通过append向form对象添加数据
  param.append('weixinName', weixinName); //通过append向form对象添加数据
  return axios({
    url: '/sys/updatecompanypayaccount',
    method: 'post',
    headers: {
      "Content-Type": "multipart/form-data"
    },
...
export function httpGetbankstatuslist() {

  return axios({
    url: '/sys/getbankstatuslist',
    method: 'get',
  })
}
...
export function httpselectProductLinks(productName) {
  let data = {
    productName
  };
  return axios({
    url: '/selectProductLinks',
    method: 'post',
    data: qs.stringify(data)
  })
}
...
export function httpGetCollecteffects(begainTimeString, endTimeString) {
  let data = {
    begainTimeString,
    endTimeString,
  }
  return axios({
    url: '/sys/collecteffects',
    method: 'post',
    data: qs.stringify(data)
  })
}

export function httpRepaytrendanalysis(npage, pagesize, salesCountType, begainTimeString, endTimeString) {
  let data = {
    npage,
    pagesize,
    salesCountType,
  ...
  return axios({
    url: '/sys/repaytrendanalysis',
    method: 'post',
    data: qs.stringify(data)
  })
}

export function httpRepayprobabilityanalysis(npage, pagesize,  begainTimeString, endTimeString) {
  let data = {
    npage,
    pagesize,
    begainTimeString,
  ...
  return axios({
    url: '/sys/repayprobabilityanalysis',
    method: 'post',
    data: qs.stringify(data)
  })
}