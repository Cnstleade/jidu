    ...
    <div class="container">
        ...
        <el-dialog
          ...
          >
            ...
            <el-form :model="roleForms" status-icon  ref="roleForms" label-width="100px"  >
              <el-form-item label="角色名:" prop="rname" >
                <el-input type="input" v-model="roleForms.rname"  ></el-input>
              </el-form-item>
              <el-form-item label="角色备注:" prop="jobTitle" >
                <el-input type="textarea"  v-model="roleForms.jobTitle" ></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" @click="submitForms('roleForms')">提交</el-button>
                <!-- <el-button @click="resetForm('ruleForm2')">重置</el-button> -->
                <el-button type="primary" style="margin-left:30px" @click="qx2('roleForms')">取消</el-button>
              </el-form-item>
            </el-form>
        </el-dialog>         
        <el-dialog
...
export default {
  ...
  methods: {
    ...
    handleRole(index, row) {
      this.roleForms = null;
      this.roleForms = Object.assign({}, row);
    ...
    submitForms(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          changeRoleList(
            this.roleForms.rid,
            this.roleForms.rname,
            this.roleForms.jobTitle
          )
            .then(res => {
              let data = res.data;
              if (data.success) {
