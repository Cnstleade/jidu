    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="stepThree" label="人脸识别" align="center" min-width="120"></el-table-column>
            <el-table-column prop="stepFour" label="运营商认证" align="center" min-width="120"></el-table-column>
            <el-table-column prop="stepFive" label="芝麻信用" align="center" min-width="120"></el-table-column>
        </el-table>  
