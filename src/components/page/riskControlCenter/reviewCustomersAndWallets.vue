        ...
        <el-row class="m20" >
            ...
            <el-tab-pane label="未通过" name="three"></el-tab-pane>
                ...
                <el-table-column prop="id" fixed label="ID" align="center" width="80"></el-table-column>
                    ...
                    <el-table-column prop="idNo" label="身份证号" align="center" width="110">
                                                               <template slot-scope="scope">
                    {{scope.row.idNo }}
                </template>
                    </el-table-column>
        ...
        <el-dialog
         ...
         >
            ...
            <el-row style="overflow: hidden;">
                    ...
                    <tr>
                        ...
                        <td colspan="5" >
                          ...
                          <template slot-scope="scope">
                                ...
                                <el-table-column label="操作" align="center" min-width="100" >
                                  <template slot-scope="scope">
                                    <el-button type="danger" icon="el-icon-info" @click="jibenxinxiClick" >编辑</el-button>
                                  </template>
                                </el-table-column>                                
                            </el-table>
                          </td>
             ...
             <tr>
                          ...
                          <template v-if="customerInformation[0]" >
                            <el-row  v-for="(imgInfo,index) in customerInformation[0].custIdcardImageList" :key="index">
                               ...
                               <el-col :span="3"   :offset="1">
                                 ...
                                 <el-col :span="3"   :offset="1">
                                        <el-button  type="danger" @click="changeImage">修改照片</el-button>   
                                </el-col>                    
                            </el-row>
                   ...
                   <tr>
                    ...
                    <el-table-column label="操作" align="center" min-width="100" >
                      <template slot-scope="scope">
                        <el-button type="danger" icon="el-icon-info" @click="changeBank(scope.row)">修改</el-button>
                      </template>
                    </el-table-column>                                
                            </el-table>
                        </td>
              ...
              width="30%"
              title="添加联系人"
              :visible.sync="tongxunlu"
              center
              append-to-body>

                <el-form :model="tongxunluForm" status-icon :rules="rules" ref="tongxunluForm" label-width="100px" class="demo-ruleForm">
                    <template v-for="(domain, index) in tongxunluForm.domains">
                    <el-form-item
                    ...
                    <el-form-item
                        ...
                        :label="'手机号' + index"
                        :key="domain.key"
                        :prop="'domains.' + index + '.mobile'"
                                               :rules="{
                          required: true, message: '手机号不能为空', trigger: 'blur'
                        }"
                    >
                          <el-input v-model="domain.mobile"></el-input><el-button @click.prevent="removeDomain(domain)">删除</el-button>
                      </el-form-item>                      
                    </template>
                                   
                  <el-form-item>
                    <el-button type="primary" @click="submitForm('tongxunluForm')">提交</el-button>
                     <el-button @click="addDomain">新增联系人</el-button>
                    <el-button @click="resetForm('tongxunluForm')">重置</el-button>
                  </el-form-item>
                </el-form>
            ...
            <el-dialog
              width="30%"
              title="编辑基本信息"
              :visible.sync="jibenxinxi"
              center
              append-to-body>

                <el-form :model="jibenxinxiForm" status-icon :rules="rules" ref="jibenxinxiForm" label-width="100px" class="demo-ruleForm">
                  <el-form-item label="姓名" prop="userName">
                    <el-input  v-model="jibenxinxiForm.userName" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="身份证" prop="idNo">
                    <el-input  v-model="jibenxinxiForm.idNo" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="手机号" prop="mobile">
                    <el-input  v-model="jibenxinxiForm.mobile" autocomplete="off"></el-input>
                  </el-form-item>                                    
                  <el-form-item>
                    <el-button type="primary" @click="submitForm('jibenxinxiForm')">提交</el-button>
                    <el-button @click="resetForm('jibenxinxiForm')">重置</el-button>
                  </el-form-item>
                </el-form>
            ...
            <el-dialog
              width="30%"
              title="编辑银行卡信息"
              :visible.sync="yinghangkaxinxi"
              center
              append-to-body>

                <el-form :model="yhkForm" status-icon :rules="rules" ref="yhkForm" label-width="100px" class="demo-ruleForm">
                  <el-form-item label="银行卡id" prop="id">
                    <el-input  v-model="yhkForm.id" autocomplete="off" disabled></el-input>
                  </el-form-item>
                  <el-form-item label="银行卡号" prop="cardNum">
                    <el-input  v-model="yhkForm.cardNum" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="银行名称" prop="bankName">
                    <el-input  v-model="yhkForm.bankName" autocomplete="off"></el-input>
                  </el-form-item>                                    
                  <el-form-item>
                    <el-button type="primary" @click="submitForm('yhkForm')">提交</el-button>
                    <el-button @click="resetForm('yhkForm')">重置</el-button>
                  </el-form-item>
                </el-form>
                            ...
                            <el-row  v-for="(imgInfo,index) in customerInformation[0].custIdcardImageList" :key="index">
                                <el-col :span="24" style="text-align:center">
                                    <template>
                                            ...
                                            <img @click="clickImg($event,imgInfo.fullfaceUrl)" :src="imgInfo.fullfaceUrl"  width="300" height="200">
                                            <el-upload
                                              style="margin: 10px 0 ;"
                                              ref="upload1"
                                              action="1"
                                              ...
                                              :auto-upload="false">
                                              <el-button slot="trigger" size="small" type="primary">选择正面照</el-button>
                               ...
                               <el-col :span="24"   style="text-align:center">
                                    <template>
                                            ...
                                            <img @click="clickImg($event,imgInfo.reverseStorageUrl)" :src="imgInfo.reverseStorageUrl"  width="300" height="200">
                                            <el-upload
                                              style="margin: 10px 0 ;"
                                              ref="upload2"
                                              action="1"
                                              ...
                                              :on-remove="handleRemove"
                                              :auto-upload="false">
                                              <el-button slot="trigger" size="small" type="primary">选择反面面照</el-button>
                               ...
                               <el-col :span="24"   style="text-align:center">
                                    <template>
                                            ...
                                            <img @click="clickImg($event,imgInfo.handStorageUrl)" :src="imgInfo.handStorageUrl"  width="300" height="200">
                                            <el-upload
                                              style="margin: 10px 0 ;"
                                              ref="upload3"
                                              action="1"
                                              ...
                                              :on-remove="handleRemove"
                                              :auto-upload="false">
                                              <el-button slot="trigger" size="small" type="primary">选择活体照</el-button>
            ...
            <el-dialog
              ...
              append-to-body>
<el-button type="danger" @click="addMobile" style="margin-bottom:20px">添加联系人</el-button>
        ...
        <el-dialog
         ...
         >
          <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-row style="margin-top:20px;font-weight:bold" v-if="reportList">
                <el-card>
                    <el-row>
                        <h3>报告详情</h3>
                    </el-row>
...
import {
  ...
  //
  httpUpdateCustomterMesage,
  httpUpdateCustomterMesageImg,
  httpUpdateCustomterMesageBank,
  httpUpdateCustomterMesageMobile
} from "@/service/http";
export default {
  data() {
    ...
    return {
      ...
      //
      jibenxinxi: false,
      xiugaizhaopian: false,
      yinghangkaxinxi: false,
      tongxunlu: false,
      jibenxinxiForm: {},
      tongxunluForm: {
        domains: [
  ...
  methods: {
    removeDomain(item) {
      var index = this.tongxunluForm.domains.indexOf(item);
      if (index !== -1) {
        this.tongxunluForm.domains.splice(index, 1);
      }
    },
    addDomain() {
      this.tongxunluForm.domains.push({
        name: "",
        mobile: ""
      });
    },
    ...
    addMobile() {
      ...
      var custMobileList = [
        {
          userId: this.customerInformation[0].userId,
          referenceMobile: this.codeRow.mobile,
          mobile: "1",
          name: "sss"
        }
      ];
    ...
    changeBank(row) {
      this.yhkForm = JSON.parse(JSON.stringify(row));
      this.yinghangkaxinxi = true;
    },
    beforeAvatarUpload1(file) {
      console.log(file);
      httpUpdateCustomterMesageImg(
        this.loginId,
        this.customerInformation[0].userId,
        file
      ).then(res => {
        let data = res.data;
        if (data.code == 200) {
          this.customerInformation[0].custIdcardImageList[0].fullfaceUrl =
            data.data.fullFaceUrl;
        }
      });
    },
    beforeAvatarUpload2(file) {
      httpUpdateCustomterMesageImg(
        ...
        let data = res.data;
        if (data.code == 200) {
          this.customerInformation[0].custIdcardImageList[0].reverseStorageUrl =
            data.data.reverseStorageUrl;
        }
      });
    },
    beforeAvatarUpload3(file) {
      httpUpdateCustomterMesageImg(
        ...
        let data = res.data;
        if (data.code == 200) {
          this.customerInformation[0].custIdcardImageList[0].handStorageUrl =
            data.data.handStorageUrl;
        }
      });
    },
    submitUpload1() {
    ...
    //changeImage
    changeImage() {
      this.xiugaizhaopian = true;
    },
    //编辑基本信息
    jibenxinxiClick() {
      this.jibenxinxiForm = {
        userId: this.customerInformation[0].userId,
        loanApplyId: this.customerInformation[0].id,
        userName: this.customerInformation[0].chbrealName,
        idNo: this.customerInformation[0].chbidcard,
        mobile: this.customerInformation[0].chbphoneNumber
      };
      this.jibenxinxi = true;
    },
    //提交
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          if (formName == "jibenxinxiForm") {
            httpUpdateCustomterMesage(
              this.loginId,
              this.jibenxinxiForm.userId,
              this.jibenxinxiForm.loanApplyId,
              this.jibenxinxiForm.userName,
              this.jibenxinxiForm.idNo,
              this.jibenxinxiForm.mobile
            )
              .then(res => {
                this.outerVisible = false;
                let data = res.data;
                if (data.code == 200) {
                  this.examine(this.codeRow);
                } else {
                  this.$message.error("网络错误");
                }
                this.jibenxinxi = false;
              })
              .catch(err => {
                // this.jibenxinxi = false;
                // this.outerVisible = false;
          ...
          if (formName == "yhkForm") {
            httpUpdateCustomterMesageBank(
              ...
              this.customerInformation[0].userId,
              this.yhkForm.id,
              this.yhkForm.cardNum,
              this.yhkForm.bankName
            ).then(res => {
              let data = res.data;
              if (data.code == 200) {
                this.yinghangkaxinxi = false;
                this.examine(this.codeRow);
              }
            });
          }
          if (formName == "tongxunluForm") {
                          this.tongxunluForm.domains.map(v=>{
                    return      v['userId'] = this.customerInformation[0].userId;
        
              })
                     this.tongxunluForm.domains.map(v=>{
                    return        v['referenceMobile'] = this.codeRow.mobile
        
              })
              
            httpUpdateCustomterMesageMobile(
              this.loginId,
              this.tongxunluForm.domains
            ).then(res => {
              let data = res.data;
              if (data.code == 200){
    ...
    examine(row) {
      this.codeRow = JSON.parse(JSON.stringify(row));

      this._httpGetCustomterMesage(row.id);
      console.log(JSON.stringify(this.codeRow));
    ...
    viewRiskManagementreport() {
      ...
      httpGetCreditReport(this.listId)
        .then(res => {
          let data = res.data;
          if (data.tdReport) {
            var arr = JSON.parse(data.tdReport.data).data.code;
            if (arr.code == 1) {
              this.reportList = {};
            } else {
