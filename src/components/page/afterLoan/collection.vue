                ...
                <template slot-scope="scope">
                  <template v-if="scope.row.updateTime">
                      {{scope.row.updateTime|dateServer}}
                        ...
                        <el-table-column prop="updateCollectTime" label="最后分配时间" align="center" width="180" sortable>
                <template slot-scope="scope">
                  <template v-if="scope.row.updateCollectTime">
                      {{scope.row.updateCollectTime|dateServer}}
                  </template>
