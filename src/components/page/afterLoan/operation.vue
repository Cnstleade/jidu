    ...
    <el-tab-pane label="进行中催收订单" name="first">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="collectEntructId" label="外包情况" align="center" width="100" >
              <template slot-scope="scope">
                            <el-tag
                                :type="scope.row.collectEntructId?'success':'danger'"
                            > {{scope.row.collectEntructId?'已外包':'未外包'}}</el-tag>                
                ...
                <el-table
                  ...
                  >
                      ...
                      <el-table-column  prop="overdue.lateFee" label="线下还款申请情况" align="center" width="140" >
                        <template slot-scope="scope" v-if="scope.row.loanRepaymentApplyId">
                            <el-tag
