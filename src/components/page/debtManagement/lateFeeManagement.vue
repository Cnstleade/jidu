 ...
 <el-row class="m20 col-flex-end" >                  
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="realrepayMoney" label="实际滞纳金额" width="120" sortable  align="center">
                <template slot-scope="scope">
                  <template >
    ...
    <el-table-column prop="overdue_day" label="M值" align="center" width="80">
            ...
            <el-table-column prop="collectorName" label="催收员" align="center" width="120">
                        <template slot-scope="scope">
                            {{scope.row.realCollectorName?scope.row.realCollectorName:scope.row.collectorName}}
                        </template> 
            </el-table-column>
        ...
        <el-row class="m20" v-if="total>0">
          <div style="float:left" >
            ...
            <el-button  type="primary" class="l20" >滞纳金合计{{allLateMoney}}</el-button> 
             <el-button  type="primary" class="l20" >实际还款本金{{allRepayActualBenjinMoney}}</el-button> 
              <el-button  type="primary" class="l20" >实际还款滞纳金{{allRePayActualOverdueMoney}}</el-button>      
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      allLateMoney: 0,
      allCostMony: 0,
      allRepayActualBenjinMoney: 0,
      allRePayActualOverdueMoney: 0,
      search: {
        paymentStatus: 1
      },
      execeedtimeTypes: [
    ...
    getData(
      ...
      getOverduemanager(
        ...
        .then(res => {
          ...
          this.allRepayActualBenjinMoney =
            data.countVo.allRepayActualBenjinMoney;
          this.allRePayActualOverdueMoney =
            data.countVo.allRePayActualOverdueMoney;
          this.loading = false;
        })
        .catch(err => {
          // let data = {
