      ...
      <el-tab-pane label="催收统计" name="first">         
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="name" label="催收员" align="center"  sortable width="110"></el-table-column>
            <el-table-column prop="allOverdueMoney" label="催收本金" align="center"  sortable width="110"></el-table-column>
            <el-table-column prop="all_late_fee" label="应催收违约金" align="center" sortable width="120"> </el-table-column>
            <!-- <el-table-column prop="borrowTime" label="借款时间" align="center" width="180" sortable>
                <template slot-scope="scope">
                    {{scope.row.borrowTime|dateServer}}
                </template>
            </el-table-column> -->
            <el-table-column prop="borrowDay" label="催回总金额" align="center" sortable  width="120">
                <template slot-scope="scope">
                    {{scope.row.collect_money_m1+scope.row.collect_money_m2+scope.row.collect_money_m3+scope.row.collect_money_m4}}
                </template>
            </el-table-column>
             <el-table-column prop="allCollectNumber" label="总数量" align="center"  sortable width="110"></el-table-column>
            <el-table-column prop="collect_money_m1" label="M1" align="center" sortable >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m1_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m1}}
                </template>
            </el-table-column>
            <el-table-column prop="collect_money_m2" label="M2" align="center"  sortable >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m2_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m2}}
                </template>              
            </el-table-column>
            <el-table-column prop="collect_money_m3" label="M3" align="center"  sortable >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m3_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m3}}
                </template>              
            </el-table-column>
            <el-table-column prop="collect_money_m4" label="M3+" align="center"  sortable >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m4_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m4}}
                </template>              
            </el-table-column>
            <el-table-column prop="collect_money_m4" label="支付宝还款" align="center"  sortable >
             <template slot-scope="scope">
                    {{scope.row.zhifuBaoRepayNumber}}个 &nbsp; &nbsp; &nbsp; {{scope.row.zhifuBaoRepayMoney}}
                </template>
            </el-table-column>
      ...
      <el-tab-pane label="催收列表成功展示" name="second"> 
        <el-row class="m20" >
          ...
          >
             ...
             <el-table-column prop="id_no" label="身份证号" align="center" width="110" >
                                                        <template slot-scope="scope">
                    {{scope.row.id_no }}
                </template>
            </el-table-column> 
