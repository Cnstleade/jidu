        ...
        <el-row class="m20">
            <el-col  class="col-flex-end">
                 <el-button  type="primary" @click="reset">重置</el-button>
                    ...
                    <el-select class="l20" v-model="search.channel" placeholder="渠道">
                      <el-option
        ...
        <el-row class="m20">
            <el-table
              ...
              >
                ...
                <el-table-column prop="idcard"  align="center" label="身份证号" width="110" >
                ...
                <el-table-column prop="channel"  align="center" label="渠道名" width="80"  ></el-table-column>    
                <el-table-column prop="custAuth"  align="center" label="认证步骤" width="100"  >
                  <template slot-scope="scope">
                      <el-tag
                          :type="scope.row.custAuth===1?'':scope.row.custAuth===2?'success':'danger'"
                      >{{scope.row.custAuth===0?'绑卡认证':scope.row.custAuth===1?'活体认证':scope.row.custAuth===2?'运营商认证':scope.row.custAuth===3?'认证成功':scope.row.custAuth===4?'芝麻认证':'绑卡认证'}}</el-tag>
                  </template>                   
                </el-table-column>    
                ...
                <!-- <el-table-column prop="custAuth"  align="center" label="认证到哪"  width="120"
                   >
                  <template slot-scope="scope">
                      <el-tag
                          :type="scope.row.custAuth===1?'':scope.row.custAuth===2?'success':'danger'"
                      >{{scope.row.custAuth===0?'绑卡认证':scope.row.custAuth===1?'活体认证':scope.row.custAuth===2?'运营商认证':scope.row.custAuth===3?'认证成功':''}}</el-tag>
                  </template> 
                </el-table-column>                                  -->
                ...
                <table class="table" >
                    ...
                    <tr class="title_6" >
                      ...
                      >{{scope.row.status===1?'正常':'冻结'}}</el-tag>
                                ...
                                <el-table-column prop="idcard" label="身份证号" align="center" width="110">
                                                                           <template slot-scope="scope">
                    {{scope.row.idcard}}
                </template>
                                </el-table-column>
