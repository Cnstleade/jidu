...
export const powerRouter = [{
  ...
  children: [{
    ...
    },
    {
     ...
     // component: resolve => require(['../components/page/systemManagement/rateofreturn'], resolve),
      meta: {
        title: '优惠券',
        role: 'discountCoupon'
      }
    },
    {
      ...
      path: '/collectentrustlist',
      //component: resolve => require(['../components/page/systemManagement/discountCouponU'], resolve),
      component: resolve => require(['../components/page/systemManagement/getcollectentrustlist'], resolve),
      meta: {
        title: '催收外包管理',
        role: 'collectentrustlist'
      }
    },
    {

      path: '/updatecompanypayaccount',
      //component: resolve => require(['../components/page/systemManagement/discountCouponU'], resolve),
      component: resolve => require(['../components/page/systemManagement/getcompanypayaccount'], resolve),
      meta: {
        title: '公司账户管理',
        role: 'updatecompanypayaccount'
      }
    },
    {
      ...
      path: '/bankstatuslist',
      // component: resolve => require(['../components/page/systemManagement/discountCouponU'], resolve),
      component: resolve => require(['../components/page/systemManagement/getbankstatuslist'], resolve),
      meta: {
        title: '银行卡服务状态',
        role: 'bankstatuslist'
      }
    },
    {
      ...
      path: '/productLinks',
      // component: resolve => require(['../components/page/systemManagement/discountCouponU'], resolve),
      component: resolve => require(['../components/page/systemManagement/ProductLinks'], resolve),
      meta: {
        title: '产品列表',
        role: 'productLinks'
      }
    },
    {
      ...
      path: '/collecteffects',
      component: resolve => require(['../components/page/systemManagement/collecteffects'], resolve),
      meta: {
        title: '催收效果统计',
        role: 'collecteffects'
      }
    ...
    {
      path: '/repaytrendanalysis',
      component: resolve => require(['../components/page/systemManagement/repaytrendanalysis'], resolve),
      meta: {
        title: '还款趋势分析',
        role: 'repaytrendanalysis'
      }
    },
